...
Таблица `{}` это очень мощная вещь в lua, позволяющая хранить любую информацию. Внутри таблицы может быть вложены другие таблицы - так создается иерархия данных (папки на компьютере).
